...
const SingleProduct = () => {
    ...
    const oldPrice = parseInt(searchParams?.get('oldPrice') || '0');
...
console.log(id, title, brand, price,image,description,isNew,oldPrice,category)
    ...
    }, [id, brand, category, description, image, isNew ,oldPrice, price, title]);
  return (
    <div className="max-w-screen-xl min-h-[80vh] mx-auto px-4 py-4 md:py-10">
    {isLoading ? (
