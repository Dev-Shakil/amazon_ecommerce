...
const CartProduct = ({item}:cartProductsPropse) => {
    ...
    return <div className={"bg-gray-100 h-fit flex-wrap lg:flex-nowrap py-3 rounded-lg flex items-center gap-4"}>
        ...
        alt="productImage"
        />
        <div className="flex items-center lg:flex-nowrap flex-wrap px-2 gap-4">
            <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-6">
                    <div className="flex items-center mt-1 justify-between border border-gray-300 px-4 py-1 rounded-full w-28 shadow-lg shadow-gray-300">
                        ...
                        }} className=" w-6 h-6 flex items-center justify-center rounded-full text-base bg-transparent hover:bg-gray-300 cursor-pointer duration-purple-300">
                            <LuPlus/>
                        </span>
